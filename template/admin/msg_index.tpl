...
<body>
  <div class="content-page">
      <div class="content-page-nav">
          <a class="nav-list"><i class="icon index-icon pull-left"></i>首页</a><a class="nav-list"> > 文章库管理 </a><a class="nav-list"> > 回复列表 </a>
      </div>
      <form action="<?=links('msg','index')?>" method="post">
      <div class="content-page-select-group row">
        ...
        <div class="col-md-1">
            <button class="content-page-btn blue-white-btn">搜回复</button>
        </div>
      </div>
      </form>
      <form action="<?=links('msg','del',0,'ac=all')?>" method="post" id="myform" name="myform">
          ...
          <div class="content-page-table">
              ...
              <table class="table table-striped no-img-table">
                  ...
                  <tr>
                      ...
                      <th class="w15">文章标题</th>
                      <th class="w30">回复内容</th>
                      <th class="small-hide">用户ID</th>
            			    <th class="small-hide">用户昵称</th>
             			    <th class="w10 small-hide">回复时间</th>
                  ...
                  <tbody>
                    ...
                    foreach ($array as $row) {
                        echo '
                            ...
                            <td class="w15">'.$row->title.'</td>
                            <td class="w30">'.$row->content.'</td>
